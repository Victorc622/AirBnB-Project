...
const bookingRouter = require("./routes/api/bookings.js");
const reviewRouter = require("./routes/api/reviews.js");
const spotRouter = require("./routes/api/spots.js");
const userRouter = require("./routes/api/users.js");
const reviewImagesRouter = require("./routes/api/review-images.js");
const spotImagesRouter = require("./routes/api/spot-images.js");
